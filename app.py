...
def compress_image_route():
    ...
    file_size = round(compressed_image_io.getbuffer().nbytes / (1024 * 1024), 2)
    ...
    return render_template('index.html', compressed_image=compressed_image_base64, image_name=image_name, file_size=file_size)
